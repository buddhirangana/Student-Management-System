...
public class NewUser extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        usertype_combo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "--------- Select Usertype --------", "Admin", "Guest" }));
    ...
    private void add_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_add_btnActionPerformed
        if (usern_txt.getText().isEmpty()) {
         ...
         try {
            ...
            String reg = "insert into Audit (User_id,Date,Status) values ('" + value + "','" + value0 + " / " + values + "','New user added')";
